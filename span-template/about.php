...
<?php include_once"layouts/nav.phtml"; ?><!doctype html>
      ...
      <section class="about-us">
        <div class="container">
          <div class="row">
            <div class="col-md-6">
              <!-- Start Touch Slider -->
              <div class="touch-slider owl-carousel owl-theme" data-slider-navigation="true" data-slider-pagination="true">
                <div class="item">
                  <img alt="" src="assets/img/about/img-1.jpg">
                </div>
                <div class="item">
                  <img alt="" src="assets/img/about/img-2.jpg">
                </div>
                <div class="item">
                  <img alt="" src="assets/img/about/img-3.jpg">
                </div>
              </div>
              <!-- End Touch Slider -->
            </div>
              ...
              <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-3">
                  <div class="counter-item">
                    ...
                    <div class="timer" id="item1" data-to="991" data-speed="5000">
                    </div>
                    <h5>
                      Happy Clients
                    </h5>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                  <div class="counter-item">
                    ...
                    <div class="timer" id="item2" data-to="7394" data-speed="5000">
                    </div>
                    <h5>
                      Project Launched
                    </h5>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                  <div class="counter-item">
                    ...
                    <div class="timer" id="item3" data-to="18745" data-speed="5000">
                    </div>
                    <h5>
                      Days Of hard Work
                    </h5>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                  <div class="counter-item">
                    ...
                    <div class="timer" id="item4" data-to="8423" data-speed="5000">
                    </div>
                    <h5>
                      Coffee Cups A week
                    </h5>
  ...
  <div class="switcher-box">
    ...
    <ul class="colors-list">
      <li>
        <a onClick="setActiveStyleSheet('bluesante'); return false;" title="Bluesante" class="bluesante">
        </a>
      </li>
