        ...
        <div class="row">
          ...
          <div class="single-gallery col-md-8">
            ...
            <div class="project-content col-md-4">
              <h5 class="widget-title">Audio infos</h5>
              <p>Lancé en 1993, Audio Infos est le magazine de référence des audioprothésistes et de toute la filière. Depuis vingt ans, la revue reflète la profession, ses problématiques et enjeux, ses perspectives et accompagne son évolution. Audio Infos traite, chaque mois, tous les thèmes qui font le quotidien de cette profession : actualités professionnelles et technologiques, reportages, interviews, portraits, dossiers thématiques, comptes rendus de manifestations, articles scientifiques, veille technologique, communication, gestion et management. Des sujets à la fois techniques et marketing qui permettent à Audio Infos de répondre aux besoins d&#39;information d&#39;une profession à la croisée entre médical, technique et commercial.</p>
              <h5 class="widget-title">Project Details</h5>
              <ul>
                <li><strong>Site web:</strong> <a href="http://www.edp-audio.fr/">audio infos</a></li>
                <li><strong>Abonnement:</strong> <a href="http://abos.edpsante.com/audio-infos-france.htm">Abonnement</a></li>
              </ul>
              <div class="share">
                <div class="social-link">
                  <span>Suivez nous sur</span>
                  <a class="twitter" target="_blank" data-original-title="twitter" href="https://twitter.com/audio_infos" data-toggle="tooltip" data-placement="top"><i class="fa fa-twitter"></i></a>
                  <a class="youtube" target="_blank" data-original-title="youtube" href="https://www.youtube.com/channel/UCoBW1Ae-d9xoWZiasDq0YLw" data-toggle="tooltip" data-placement="top"><i class="fa fa-youtube"></i></a>
                  <a class="google" target="_blank" data-original-title="google-plus" href="https://plus.google.com/103510988204477340688" data-toggle="tooltip" data-placement="top"><i class="fa fa-google-plus"></i></a>
                </div>
              </div>
            </div>
            <!-- End Project Content -->
