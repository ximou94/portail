        ...
        <div class="row">
          ...
          <div class="single-gallery col-md-8">
            ...
            <div class="project-content col-md-4">
              <h5 class="widget-title">Audiology infos</h5>
              <p>Créée en 2008, la revue Audiology Infos se propose d&#39;agir comme révélateur et catalyseur des énergies et des initiatives en matière d&#39;audition, qu&#39;il s&#39;agisse de recherche, de modalités diagnostiques, de traitements, de chirurgie, de rééducation ou d&#39;appareillage. Au fil de ces années d’existence, Audiology Infos s’est imposée dans le monde de l’information professionnelle des médecins ORL sur les thématiques de l’audioprothèse et de l’audiologie.</p>
              <p>Au carrefour des savoirs et des actualités de l’audiologie en France et dans le monde et à l’écoute des acteurs de terrain, chaque numéro se veut un reflet de la pluridisciplinarité et de l’ouverture caractéristique de la spécialité.</p>
              <h5 class="widget-title">Project Details</h5>
              <ul>
                <li><strong>Site web:</strong> <a href="http://www.edp-audio.fr/">audio infos</a></li>
                <li><strong>Abonnement:</strong> <a href="http://abos.edpsante.com/audiology-infos.htm">Abonnement</a></li>
              </ul>
              <div class="share">
                <div class="social-link">
                  <span>Suivez nous sur</span>
                  <a class="twitter" target="_blank" data-original-title="twitter" href="https://twitter.com/Audiology_infos" data-toggle="tooltip" data-placement="top"><i class="fa fa-twitter"></i></a>
                </div>
              </div>
            </div>
            <!-- End Project Content -->
