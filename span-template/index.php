          ...
          <div class="tp-banner">
            <ul>
              <li data-transition="fade" data-slotamount="7" data-masterspeed="2000" data-thumb="assets/img/slider/slide1.jpg" data-bgfit="cover" data-delay="5000" data-saveperformance="on" data-title="Ken Burns Slide">
                ...
                <!-- LAYER NR. 2 -->
                <!-- Device 1 -->
                <div data-endelementdelay="0.1" data-elementdelay="0.1" data-easing="Power4.easeInOut" data-start="800" data-speed="1200" data-endeasing="Power4.easeIn" data-endspeed="800" data-customout="x:-200;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0.75;scaleY:0.75;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;" data-y="80" data-x="651" class="tp-caption lfr customout rs-parallaxlevel-2 start"><img alt="Image Title" src="assets/img/slider/device1.png" style="width: 360.94px; height: 288.563px;">
                </div>
              </li>
              <li data-transition="zoomout" data-slotamount="7" data-masterspeed="2000" data-thumb="assets/img/slider/slide2.jpg" data-bgfit="cover" data-delay="5000" data-saveperformance="on" data-title="Ken Burns Slide">
                <!-- MAIN IMAGE -->
              ...
              <li data-transition="zoomin" data-slotamount="7" data-masterspeed="2000" data-thumb="assets/img/slider/slide3.jpg" data-bgfit="cover" data-delay="5000" data-saveperformance="on" data-title="Ken Burns Slide">
                <!-- MAIN IMAGE -->
            ...
            <div class="heading">
              ...
              <div class="filter-right">
                ...
                <ul class="controls">
                  ...
                  <?php foreach ($sector as $key => $value):?>
                    <li class="filter" data-filter=".<?= $nav->getNavLevel0Name($key)?>"><?= $nav->getNavLevel0Name($key)?></li>
                  <?php endforeach ?>
                </ul>
              </div>
            </div>
